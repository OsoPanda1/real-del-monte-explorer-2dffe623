  ...
  return (
    <section className="relative min-h-screen flex items-end overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 pb-20 pt-40">
        ...
        >
          <span className="inline-block font-mono text-xs uppercase tracking-widest text-primary mb-4">
          ...
          <p className="max-w-lg text-muted-foreground text-lg leading-relaxed mb-8">
